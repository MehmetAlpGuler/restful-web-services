...
public class CustomerControllerTest {
    ...
    @Before
    public void init() {
        Customer customer = new Customer(1L, "alp", "guler","mehmetalpguler@gmail.com", "111111111", "Tallinn/Estonia", null);
    ...
    public void find_customerId_OK() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/customers/1"))
                ...
                .andExpect(jsonPath("$.name", is("alp")))
                .andExpect(jsonPath("$.lastname", is("guler")))
                .andExpect(jsonPath("$.mail", is("mehmetalpguler@gmail.com")))
    ...
    public void find_allCustomer_OK() throws Exception {
        ...
        List<Customer> customers = Arrays.asList(
                new Customer(1L, "alp", "guler","mehmetalpguler@gmail.com", "111111111", "Tallinn/Estonia", null),
        ...
        mockMvc.perform(get("/api/v1/customers"))
                ...
                .andExpect(jsonPath("$[0].name", is("alp")))
                .andExpect(jsonPath("$[0].lastname", is("guler")))
                .andExpect(jsonPath("$[0].mail", is("mehmetalpguler@gmail.com")))
    ...
    public void update_customer_OK() throws Exception {
        ...
        Customer updateCustomer = new Customer(1L, "alp", "guler","mehmetalpguler@gmail.com", "111111111", "Tallinn/Estonia", null);
